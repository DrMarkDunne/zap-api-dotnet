...
namespace OWASPZAPDotNetAPI.Generated
{
    public class OpenApi
    {
        ...
        public IApiResponse ImportFile(string file)
        {
            ...
            return _api.CallApi("openapi", "action", "importFile", parameters);
        }
        ...
        {
            var parameters = new Dictionary<string, string> { { "url", url }, { "hostOverride", hostOverride } };
            return _api.CallApi("openapi", "action", "importUrl", parameters);
        }
