...
namespace OWASPZAPDotNetAPI.Generated
{
    public class Reveal
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IApiResponse RevealHiddenFields()
        {
            return _api.CallApi("reveal", "view", "reveal", null);
        }
        ...
        {
            var parameters = new Dictionary<string, string> { { "reveal", reveal } };
            return _api.CallApi("reveal", "action", "setReveal", parameters);
        }
    }
}
